...
public final class RetryConfig implements InqConfig {
    ...
    public Set<Class<? extends Throwable>> getRetryOn() { return retryOn; }
    public Set<Class<? extends Throwable>> getIgnoreOn() { return ignoreOn; }
    ...
    public static final class Builder {
        ...
        public Builder initialInterval(Duration initialInterval) { this.initialInterval = Objects.requireNonNull(initialInterval); return this; }
        public Builder backoffStrategy(BackoffStrategy strategy) { this.backoffStrategy = Objects.requireNonNull(strategy); return this; }
        public Builder maxInterval(Duration maxInterval) { this.maxInterval = Objects.requireNonNull(maxInterval); return this; }
        public Builder retryOn(Class<? extends Throwable> exceptionType) { this.retryOn.add(exceptionType); return this; }
        public Builder ignoreOn(Class<? extends Throwable> exceptionType) { this.ignoreOn.add(exceptionType); return this; }
