...
public abstract class InqFallbackConfigBuilder
        <B extends InqFallbackConfigBuilder<B, E>, E extends ConfigExtension<E>>
    ...
    protected InqFallbackConfigBuilder() {
    }
    ...
    public InqFallbackConfigBuilder<B, E> enableExceptionOptimization(Boolean enableExceptionOptimization) {
    ...
    protected InqFallbackConfig common() {
     ...
     */
    private void validate(InqFallbackConfig config) {
