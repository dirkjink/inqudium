...
class DefaultRateLimiterProtection implements RateLimiterProtection {
  ...
  public RateLimiterConfig applyStrictProfile() {
    ...
    return new RateLimiterConfig(10, Duration.ofSeconds(1), Duration.ZERO);
  }
  ...
  public RateLimiterConfig applyBalancedProfile() {
    ...
    return new RateLimiterConfig(100, Duration.ofSeconds(1), Duration.ofMillis(500));
  }

  @Override
  public RateLimiterConfig applyPermissiveProfile() {
    // Permissive: High burst capacity, long wait allowed
    return new RateLimiterConfig(1000, Duration.ofSeconds(1), Duration.ofSeconds(5));
  }

  @Override
  public RateLimiterConfig apply() {
    return new RateLimiterConfig(limitForPeriod, limitRefreshPeriod, timeoutDuration);
  }
}
