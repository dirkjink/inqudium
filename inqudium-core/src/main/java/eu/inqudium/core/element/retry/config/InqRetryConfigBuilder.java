...
public abstract class InqRetryConfigBuilder
        <B extends InqRetryConfigBuilder<B, E>, E extends ConfigExtension<E>>
    ...
    protected InqRetryConfigBuilder() {
    }
    ...
    public InqRetryConfigBuilder<B, E> enableExceptionOptimization(Boolean enableExceptionOptimization) {
    ...
    protected InqRetryConfig common() {
     ...
     */
    private void validate(InqRetryConfig config) {
