...
public abstract class InqRatelimiterConfigBuilder
    <B extends InqRatelimiterConfigBuilder<B, E>, E extends ConfigExtension<E>>
  ...
  protected InqRatelimiterConfigBuilder() {
  }
  ...
  public InqRatelimiterConfigBuilder<B, E> enableExceptionOptimization(Boolean enableExceptionOptimization) {
  ...
  protected InqRatelimiterConfig common() {
   ...
   */
  private void validate(InqRatelimiterConfig config) {
