 ...
 *             configuration redesign (ADR-025). Retained because the imperative
 *             {@link eu.inqudium.imperative.bulkhead.config.InqImperativeBulkheadConfig
 *             InqImperativeBulkheadConfig} and the legacy
 *             {@code eu.inqudium.imperative.bulkhead.Bulkhead} interface still reference it;
 *             removed once the legacy circuit breaker is migrated to the new architecture and
 *             the legacy bulkhead surface alongside it can be dropped.
 */
