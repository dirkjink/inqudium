...
public abstract class InqTimelimiterConfigBuilder
        <B extends InqTimelimiterConfigBuilder<B, E>, E extends ConfigExtension<E>>
    ...
    protected InqTimelimiterConfigBuilder() {
    }
    ...
    public InqTimelimiterConfigBuilder<B, E> enableExceptionOptimization(Boolean enableExceptionOptimization) {
    ...
    protected InqTimelimiterConfig common() {
     ...
     */
    private void validate(InqTimelimiterConfig config) {
