...
public final class RateLimiterConfig implements InqConfig {
    ...
    public static final class Builder {
        ...
        public Builder limitForPeriod(int limitForPeriod) { this.limitForPeriod = limitForPeriod; return this; }
        public Builder limitRefreshPeriod(Duration period) { this.limitRefreshPeriod = Objects.requireNonNull(period); return this; }
        public Builder bucketSize(int bucketSize) { this.bucketSize = bucketSize; return this; }
