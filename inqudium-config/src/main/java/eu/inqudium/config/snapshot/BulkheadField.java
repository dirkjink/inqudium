 ...
 * {@link ComponentField} discriminator inside a {@code ChangeRequest&lt;BulkheadSnapshot&gt;}.
 * The {@code derivedFromPreset} field participates in normal touch logic: preset methods touch
 * it, individual setters do not, and a hot patch that does not call a preset inherits the
...
public enum BulkheadField implements ComponentField {
    ...
    /** The {@link BulkheadStrategyConfig} choosing the bulkhead's permit-management algorithm. */
    STRATEGY
}
