...
Quick-reference hub for all Inqudium element configurations. Each element's full configuration documentation — including
parameter tables, defaults, and examples — lives on its own page.
